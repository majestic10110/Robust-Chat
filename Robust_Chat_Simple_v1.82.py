...
class RobustChatSimpleV16:
    def __init__(self, master: tk.Tk):
        self.master = master
        self.master.title("Robust Chat Simple v1.82")
    ...
    def _compute_ack_timeout(self, wire_len_bytes: int) -> float:
        ...
        ack_timeout = max(4.0, tx_time * 2.0 + 1.0)
        return ack_timeout
    ...
    def _build_ui(self):
        ...
        self.connect_btn = ttk.Button(conn, text="Connect", command=self.connect_port, style="Conn.TButton")
        ...
        self.freq_combo.grid(row=0, column=11, padx=(0, 8))
